...
class LearnHomePage extends StatefulWidget {
  ...
  const LearnHomePage({Key key, this.userId}) : super(key: key);


  @override
  _LearnHomePageState createState() => _LearnHomePageState();
}

class _LearnHomePageState extends State<LearnHomePage> with SingleTickerProviderStateMixin {
