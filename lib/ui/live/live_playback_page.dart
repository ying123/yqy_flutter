...
class LivePaybackPage extends StatefulWidget {
  @override
  _LivePaybackPageState createState() => _LivePaybackPageState();
}

class _LivePaybackPageState extends State<LivePaybackPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          new Container(
            padding: EdgeInsets.fromLTRB(ScreenUtil().setWidth(30),ScreenUtil().setWidth(30), ScreenUtil().setWidth(30),ScreenUtil().setWidth(30)),
            child: Column(
              ...
              children: <Widget>[
                ...
                new Row(
                  ...
                  children: <Widget>[
                    Text("2019-12-22  08：00-2019-12-23  17:00", style: TextStyle(
                ...
                Visibility(
                    ...
                    child: new Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text("视频简介视频简介视频简介", style: TextStyle(
                            color: Color(0xFF999999),
                            fontSize: ScreenUtil().setSp(35)),),
                      ],
                    )
          ...
          new Container(
            ...
            child:  Row(
              ...
              children: <Widget>[
                cXM(ScreenUtil().setWidth(30)),
                Expanded(child: Text("2296次播放",style: TextStyle(color: Color(0xFF999999),fontSize: ScreenUtil().setSp(32)),),),
                Icon(Icons.star_border,size: ScreenUtil().setWidth(70),color: Colors.black26),
                cXM(ScreenUtil().setWidth(58)),
                Icon(Icons.favorite_border,size: ScreenUtil().setWidth(60),color: Colors.black26,),
                cXM(ScreenUtil().setWidth(30)),
  ...
  ///  切换其他分会场布局
  ///
  buildOtherVideoView(BuildContext context) {
    return  Container(
        margin: EdgeInsets.all(ScreenUtil().setWidth(30)),
