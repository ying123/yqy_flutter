class DoctorInfoEntity {
	...
	DoctorInfoEntity({this.message, this.status, this.info});

	DoctorInfoEntity.fromJson(Map<String, dynamic> json) {
		message = json['message'];
		status = json['status'];
		info = json['info'] != null ? new DoctorInfoInfo.fromJson(json['info']) : null;
	}
