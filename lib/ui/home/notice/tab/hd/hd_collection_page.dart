...
class HdCollectionPage extends StatefulWidget {
  @override
  _HdCollectionPageState createState() => _HdCollectionPageState();
}

class _HdCollectionPageState extends State<HdCollectionPage> {
  @override
  ...
  getCollectionItemView(BuildContext context) {
