...
class HdCommentPage extends StatefulWidget {
  @override
  _HdCommentPageState createState() => _HdCommentPageState();
}

class _HdCommentPageState extends State<HdCommentPage> {
  @override
  ...
  getCommentItemView(BuildContext context) {
